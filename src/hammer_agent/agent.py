...
class Operator:
    ...
    def run(self, task, run_config):
        ...
        goal, screenshot = obs["goal"], obs["screenshot"]
        ...
        while step < self.max_steps:
            ...
            result = Runner.run_sync(
                ...
                input=_input_msg(goal, screenshot, _history),
        ...
        result = self.device_client.submit()
...
def _input_msg(goal, screenshot, history):
    return [
        ...
        {
            "role": "user",
            "content": ACTION_SELECTION_PROMPT_TEMPLATE.format(goal=goal, history=history),
        },
    ]
